...
const CreatePost =()=> {
    ...
    useEffect(()=>{
        if(url){
            fetch(`${process.env.REACT_APP_SERVER_BASE_URL}/createpost`,{
                method:"post",
                headers:{
            ...
            .then(data => {
                ...
                if(data.error){
                    ...
                    M.toast({html:'Post Upload Successfully',classes:"#00c853 green accent-4"})
                    history.push('/')
                }
    ...
    const postDetails = ()=>{
        ...
        return ( 
            <div className="card input-filed">
                ...
                <button className="btn waves-effetc waves-darken-1" onClick={()=>postDetails()} >Post</button>
            </div>
         );
}
